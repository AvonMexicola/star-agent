...
| Ships | Flyable Nomad 02, Kestrel, current 64 m Atlas, 18 m Stratum miner and 24 m Gannet rover transport; physical boarding, mining and loaded-flight journeys pass | Medium hulls remain solo/offline; broad fleet performance, final Atlas materials and Kestrel ladder animation remain open |
...
| Multiplayer | Twenty-slot public prototype on paired protocol10, persistent PostgreSQL/Prisma accounts and inventory, comms-assigned hangars, authoritative hits, assigned remote suit colors | Local database survives restarts; no SMTP; online Nomad/Atlas cargo hulls, with remaining fleet parity open; live ten-person soak not established here |
