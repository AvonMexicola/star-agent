...
| Combat | Fifteen offline regional Nomad/Kestrel sorties across planets, moons and belt; Easy/Standard/Hard, reinforcement waves, shield/hull damage, recovery and session reports; five full regional controller routes pass | No credits/loot, durable missions or multiplayer NPC authority; physical-device testing and independent human difficulty tuning remain pending |
