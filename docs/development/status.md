...
**Snapshot: 2026-09-07, combined review plus SBU cargo runtime `3c7af88`.** This page states
...
persistence checks; see [cargo QA](../qa/sbu-cargo.md). Chat/friends and base power
continue in separate branches at this checkpoint.
