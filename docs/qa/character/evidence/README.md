...
| Rifle grip refinement | [Initial loose closure](initial-loose-rifle-grip.png) | [Final closure](final-rifle-hands.png) |
...
The reviewer then captured nine additional fresh equipment frames after raising
the support palms along the vertical grips: [rifle hands](final-rifle-hands.png),
[rifle palms](final-rifle-palms.png), [cutter hands](final-cutter-hands.png),
[cutter palms](final-cutter-palms.png). The [final grip record](final-grip-record.json)
reports zero errors/warnings. These supersede the earlier grip views above.
The [independent addendum](../visual-grip-addendum.md) confirms both hands enclose
the real foregrips and accepts the overall visual change at **4.33/5**.
...
The last 14–18 mm support-centre adjustment was subsequently verified by the
real-rig suite, a passing production studio rerun and the independent close-ups
above; the gameplay/GPU captures precede that final small calibration.
