...
- `npm test`: 90 test-file entries pass, including the new combat simulation tests.
...
581–582 draw calls and 457–479k triangles. These are renderer counters during
