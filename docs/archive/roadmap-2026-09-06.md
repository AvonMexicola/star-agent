...
This preserves the earlier plan. Its model assignments, controls, service claims,
prices, capacity estimates and technology choices are historical, not current
authority or verified capabilities. Read [the current roadmap](../../ROADMAP.md).
