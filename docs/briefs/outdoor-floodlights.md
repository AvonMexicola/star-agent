...
Place lights around each settlement's pad and on suitable service-building
roofs, preserving every supported ship's landing envelope and all door/ramp
...
base32966e3, preview5652. New asset and lighting modules are isolated first;
