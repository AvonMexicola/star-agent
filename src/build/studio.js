...
const kit=expansion?[['foundation-quarter',-4,0,0],['window-quarter',-4,0,0],['floor-quarter',-4,3,0],['foundation',-4,0,-4],['wall',-6,0,-4,Math.PI/2],['floor',-4,3,-4],['foundation-triangle',2,0,0],['wall',2,0,-1.154700538],['floor-triangle',2,3,0],['foundation',6,0,-4],['rack',5.5,0,-4,Math.PI],['terminal',7.2,0,-4,Math.PI],['foundation-ramp',6,0,2]]:only?[[only,0,0,0,PIECES[only]?.padSize?0:Math.PI]]:[['foundation',-5,0,-3],['wall',-5,0,-5],['window',-7,0,-3,Math.PI/2],['doorway',-5,0,-1],['foundation',0,0,-3],['stairs',0,0,-3],['floor',0,3,-7],['foundation',5,0,-3],['mainframe',4,0,-3,Math.PI],['crate',5.7,0,-3,Math.PI],['floor',-5,0,4],['wall',0,0,4],['window',5,0,4]];
