...
export class PiratePerimeter {
  ...
  update(dt,{distance,ship=false,active=true,clear=true,aligned=true}={}){
    ...
    if(!ship||distance>P.disengage&&this.phase!=='idle'&&this.phase!=='warning'||distance>P.warning){this.phase='idle';this.timer=0;this.burst=0;return;}
