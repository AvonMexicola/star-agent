...
const maker=document.createElement('img');maker.src=MERIDIAN.emblemURL;maker.alt='Meridian Shipworks';maker.className='studio-maker';document.querySelector('.studio-heading').prepend(maker);
