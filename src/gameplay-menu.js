...
export function createGameplayMenu({nav,screens,dev=false}){
  ...
  const shipKeys=new Set(['resume','combat-mode','free-drive','gear','lights','camera-view','combat-target','power','fleet','crash-recover','weapon-pulse','weapon-laser','weapon-void','build','recipes','tool']);
