...
export function createDevLauncher({nav,options,seed,available=()=>true}){
  const trigger=document.createElement('button');trigger.id='dev-launch-button';trigger.type='button';trigger.textContent='DEV · SHIP / LOCATION';trigger.title='Scene options · F2 / Menu → Dev';trigger.disabled=true;
