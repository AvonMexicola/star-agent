...
export const CATALOG = Object.freeze([
  ...
  ...PROCESSED_IDS.map(id => ({ id, name: ({aggregate:'Aggregate', 'mineral-binder':'Dry mineral binder', concrete:'Dry mineral concrete', 'metal-stock':'Metal stock', conductor:'Conductor stock', glass:'Basic glass'})[id], detail:'Field-processed construction material', mass:1, unit:'kg', stack:4, color:'#b5c8bc' })),
