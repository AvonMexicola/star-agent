...
export const SETTLEMENTS = Object.freeze([
  {id:'settlement-aeon',body:'aeon',name:'Greenbank Supply',role:'Construction supplies',wings:[4,28],
  ...
  {id:'settlement-selene',body:'selene',name:'Stillwater Exchange',role:'Ice and mineral freight',wings:[24,4],
  ...
  {id:'settlement-pyre',body:'pyre',name:'Ember Works',role:'Metal and conductor export',wings:[28,28],
  ...
  {id:'settlement-miasma',body:'miasma',name:'Verdigris Prospect',role:'Copper prospecting',wings:[4,12],
