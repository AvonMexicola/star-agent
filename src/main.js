...
try {
  ...
  const controllerUI=createControllerUI({nav,openBuild:()=>buildUI.open(),openRecipes:()=>buildUI.openRecipes(),buildActive:()=>build.active,handleBuild:pad=>buildUI.handleController(pad),actions:[
