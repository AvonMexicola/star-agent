...
try {
  ...
  const opening=introEnabled?new OpeningSequence({scene,nav,station,character,onGesture:()=>{
  ...
  function updateHud(time){
    ...
    $('camera-button').disabled=!['flight','landed','walk','eva'].includes(nav.mode);
    if(course){
  ...
  function frame(time){
    ...
    if(!opening?.active){
      ...
      character.setVisible(onFoot&&shipCamera.active);
    }
