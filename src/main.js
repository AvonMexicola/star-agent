...
try {
  ...
  function frame(time){
    ...
    effects.update(dt,{origin,camera,mining:effects.miningInput,collector:miningTool.equipment.muzzleWorldPosition()??origin,
