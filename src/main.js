...
if(atlasMeadowStart&&SEED!==ATLAS_MEADOW_SEED){
  ...
  function updateHud(time){
    ...
    if(guidance?.departing&&nav.mode==='flight'&&!nav.stationLift&&nav.stationDistance<500)$('state-text').textContent=controller?'DEPARTURE · LS FORWARD THROUGH THE OPEN DOORS':'DEPARTURE · W TO FLY THROUGH THE OPEN DOORS';
