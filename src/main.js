...
try {
  ...
  function frame(time){
    ...
    ship.visible=Boolean(nav.shipPosition)||(nav.mode==='flight'&&(nav.shipId==='kestrel'||nav.locked||nav.controllerActive||shipCamera.engaged));
    if(ship.visible){
