...
try {
  ...
  function frame(time){
    ...
    ship.visible=Boolean(nav.shipPosition)||(nav.mode==='flight'&&(nav.locked||nav.controllerActive||shipCamera.engaged||document.body.classList.contains('player-active')));
    if(ship.visible){
