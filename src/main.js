...
try {
  ...
  function frame(time){
    ...
    if(systemMap.open){audio.gameplay?.suspend();resolution.resetMeasurements();nav.update(0);return;}
    elapsed+=dt;
