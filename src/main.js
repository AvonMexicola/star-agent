...
try {
  ...
  function frame(time){
    ...
    audio.update({speed:nav.speed,altitude,musicAltitude:nav.flightEnvironment.altitude,verticalSpeed:nav.velocity.dot(nav.normal),mode:nav.mode,boost:nav.boost,airless:nav.body.airless,inHangar,doorMotion:station.doorsOpen>0&&station.doorsOpen<1?1:0},dt);
