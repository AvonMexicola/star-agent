...
import { MineableRock } from './mining/rock.js';
...
try {
  ...
  const mining=new MineableRock(scene,localInventoryStorage);nav.surfaceObstacles=mining;
  ...
  function frame(time){
    ...
    mining.update(origin);miningTool.update(dt,origin);
