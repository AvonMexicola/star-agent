...
try {
  ...
  function frame(time){
    ...
    planet.update(origin,origin,sunDirection,elapsed,Math.max(0,origin.length()-RADIUS));vegetation.setExclusion?.(nav.shipPosition);vegetation.update(origin,origin,elapsed);
