...
const layouts={
  flight:{note:'Fly-by-wire brakes and corrects drift gradually. R3 unlocks coasting: turn around while travelling backwards. Hold LT to brake; heavy ships need more room. Menu → Ship selects combat/cruise independently. RT fires in combat at or below Kestrel 220 / Nomad 180 / Atlas 120 m/s, with boost off and gear retracted. Aim at a nav marker to charge; LB + RB + ↑ engages.',left:[['LT / L2 (hold)','Full braking thrust · abort drive'],...movement,['L3','Hold to boost'],['D-pad ↑ / ↓','Adjust flight speed'],['D-pad ←','System map']],right:[['RT / R2','Fire ship weapon'],['A / ✕','Rise'],['B / ○','Descend'],['X / □','Interact · enter / leave seat'],['Y / △','Land / dock below 10 m/s · launch'],['R3','Toggle fly-by-wire / unlocked coast'],...shared]},
