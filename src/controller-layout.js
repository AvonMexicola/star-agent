...
const layouts={
  flight:{note:'Hold RT to fire. Aim with the right stick; use Menu to choose a weapon or next hostile.',left:[['LT / L2','Brake · disengage drive'],...movement,['L3','Hold to boost'],['D-pad ↑ / ↓','Adjust flight speed'],['D-pad ←','System map']],right:[['RT / R2','Fire ship weapon'],['A / ✕','Rise'],['B / ○','Descend'],['X / □','Interact · enter / leave seat'],['Y / △','Land / dock / launch'],['R3','Toggle flight assist'],...shared]},
  walk:{note:'RT uses your held weapon or mining tool. Open the command menu for equipment, recipes and building.',left:[['LT / L2','Stop movement'],['LS','Walk / strafe'],['RS','Look / aim'],['L3','Hold to sprint'],['D-pad ← / →','Cycle equipment / mining tool'],['D-pad ↑ / ↓','Select quick item / use item']],right:[['RT / R2','Fire weapon / mine'],['A / ✕','Jump'],['X / □','Interact · doors / cargo / seat'],['Y / △','Toggle suit thrusters'],...shared]},
  eva:{note:'Release thrust to coast. Hold LT to stop drifting before returning to the open ship ramp.',left:[['LT / L2','Brake drift'],...movement,['L3','Hold to boost'],['D-pad ← / →','Cycle equipment / mining tool'],['D-pad ↑ / ↓','Select quick item / use item']],right:[['RT / R2','Fire weapon / mine'],['A / ✕','Rise'],['B / ○','Descend'],['X / □','Interact / board'],['Y / △','Toggle suit thrusters'],...shared]},
  shortcuts:{note:'Hold both bumpers, then press a direction or Menu. Release both bumpers before rolling again.',left:[['LB + RB · L1 + R1','Hold for shortcuts'],['+ D-pad ↑','Heading drive on / off'],['+ D-pad ↓','Landing gear'],['+ D-pad ←','Ship lights / flashlight'],['+ D-pad →','Change camera'],['+ Menu / Options','Graphics settings']],right:[['In any dialog','Release controls to begin'],['D-pad / LS','Move visible selection'],['A / ✕','Confirm'],['B / ○','Close · return to play'],['RS','Scroll'],['Menu / Options','Close dialog']]}
};
...
export function createControllerLayout({nav}){
  ...
  return {open(){
    ...
    select(nav.mode==='eva'?'eva':nav.mode==='walk'?'walk':'flight');
