...
const layouts={
  ...
  rover:{note:'Burrow uses the existing RT firing position for its twin mining beams. When aboard Atlas, stop clear of its rear ramp before operating it.',left:[['LT / L2','Brake rover'],['LS','Drive forward / reverse · steer'],['RS','Aim the two cutter heads'],['LB + RB + D-pad →','Cockpit / chase camera']],right:[['RT / R2','Hold twin mining beams'],['X / □','Board / leave closed cabin'],['Y / △','Operate Atlas rear ramp'],['View / Share','Rover ore bins'],['Menu / Options','Gameplay menu']]},
