...
export default defineConfig({
  testDir: '.', testMatch: 'ship-studio.spec.js', timeout: 60000, workers: 1,
  ...
  webServer: { command: 'npm run dev -- --config scripts/ship-vite.config.js --port 5190 --strictPort', url: 'http://127.0.0.1:5190', reuseExistingServer: false },
});
