...
export default defineConfig({
  ...
  webServer: [
    { command: 'node scripts/social-browser-server.mjs', env: { NODE_ENV: 'test', PUBLIC_ORIGIN: 'http://127.0.0.1:5544',
    ...
    { command: 'VITE_MULTIPLAYER_ENTRY=1 npm run build && MULTIPLAYER_SERVER=http://127.0.0.1:8094 npm run preview -- --host 127.0.0.1 --port 5544',
