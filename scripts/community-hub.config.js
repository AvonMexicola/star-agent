...
export default defineConfig({
 ...
 webServer:[
  {cwd,command:'node scripts/community-hub-server.mjs',env:{NODE_ENV:'test',DATABASE_URL:'',STAR_AGENT_MEMORY:'1',SMTP_HOST:'',SMTP_USER:'',SMTP_PASSWORD:''},url:'http://127.0.0.1:8098/api/health',reuseExistingServer:false,timeout:30000},
  {cwd,command:'VITE_MULTIPLAYER_ENTRY=1 VITE_DEV_TOOLS=1 npm run build -- --outDir /home/cees/projects/.community-hub-qa/dist && MULTIPLAYER_SERVER=http://127.0.0.1:8098 npm run preview -- --host 127.0.0.1 --port 5564 --outDir /home/cees/projects/.community-hub-qa/dist',url:'http://127.0.0.1:5564',reuseExistingServer:false,timeout:90000},
 ],
});
