...
async function setup(page,context,mode,callsign){
 ...
 if(await page.locator('#dev-launcher').isVisible()){await activate(page,mode,'tab-comms');await activate(page,mode,'comms-flight');await activate(page,mode,'comms-account');}
