// Reviewer-authored, root-executed native PBR fixture. One launch, no retry.
...
import {ROOT,ASSET,LAYOUT,EXPECTED_SHA,EXPECTED_HUMAN_SHA,outputPath} from './config.mjs';
...
{name:'03-cockpit',cockpit:true,label:'PILOT EYE / ASSET INTERIOR / LIVE DISPLAY IS A SEPARATE RUNTIME CHECK'},
