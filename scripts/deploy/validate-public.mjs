...
for(const path of ['dist/solo/index.html','dist/solo/release.json','site/media/flight.mp4','site/media/hangar.mp4','site/media/field-notes.mp4'])if((await stat(path)).size===0)throw Error(`Empty release file: ${path}`);
