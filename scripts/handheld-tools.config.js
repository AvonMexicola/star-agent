...
export default defineConfig({testDir:'..',testMatch:/tests\/(handheld-tools\/visual|tool-visual\/visual|browser\/cargo-tractor)\.spec\.js$/,
  ...
  webServer:{command:'VITE_DEV_TOOLS=1 node tests/handheld-tools/build-preview.mjs && npm run preview -- --port 5578 --strictPort',url:'http://127.0.0.1:5578',reuseExistingServer:false,timeout:120000}});
