...
export default defineConfig({
  ...
  outputDir: '/tmp/star-agent-multiplayer-evidence/results',
  use: {
    baseURL: 'http://127.0.0.1:5301', viewport: { width: 1280, height: 720 },
    launchOptions: { executablePath: '/usr/bin/chromium', args: ['--no-sandbox', '--enable-gpu', '--ignore-gpu-blocklist', '--disable-dev-shm-usage', '--use-gl=angle', '--use-angle=gl'] },
  },
  webServer: [
