...
SA-MULTIPLAYER STATIC CLIENT CORRECTION 2026-09-08T00:31:22.345342+00:00: Cees authorized the reported startup/cache correction within the existing release. Peirce owns the isolated clean release/multiplayer-fleet-refresh worktree from9422285, adapting only checked5879ec8+c885f5c startup/model-cache source and exact QA. Build remains VITE_DEV_TOOLS=1 with multiplayer API/Comms and protocol5/cap20. Target multiplayer.staragent.site; current API623430d/PID19466 remains running. Stage a backed-up static dist and atomically switch only that path, retaining old hashed assets for open clients. No server source, service restart, environment, database, public-current, local previews or GPU changes. Parent owns combined source/browser acceptance; exact static receipt and branch push follow focused checks.


SA-MULTIPLAYER STATIC CORRECTION LIVE 2026-09-08T00:36:17Z: client b51fa894b1b1e26784f235b2de1e475ad98d8a5c / main-CcHQYLAx.js is now served at multiplayer.staragent.site. Checked49 focusedCPU tests/build/repo/whitespace pass; parent independently reviewed the MP adapter.223 stagedfiles match;37 previous hashedassets retained; atomic dist exchange preserves complete prior static backup.10 public HTTPS artifact hashes including6 versionedmodels and oldmain pass; APIhealth remainsOK. Server623430d, PID19466/starttime,442 runtimecode files and environment remain unchanged; no SQL/account/GPU/APIrestart/public-current/localpreview mutation. Branch release/public-multiplayer pushed; exact client/server metadata and rollback evidence recorded in docs/PUBLIC-MULTIPLAYER-RELEASE.md and docs/qa/multiplayer/static-correction-2026-09-08.json. Current client now enters Nomad shoulder and keeps optionalF2/Menu scenes and Comms/login.
